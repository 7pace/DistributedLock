...
namespace Medallion.Threading.SqlServer
{
    ...
    public sealed class SqlConnectionOptionsBuilder
    {
        ...
        internal static (TimeoutValue keepaliveCadence, bool useTransaction, bool useMultiplexing, string? accessToken) GetOptions(Action<SqlConnectionOptionsBuilder>? optionsBuilder)
        {
            ...
            var accessToken = options?._accessToken;
            ...
            return (keepaliveCadence, useTransaction, useMultiplexing, accessToken);
        }
    }
}